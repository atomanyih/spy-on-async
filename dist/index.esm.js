...
var untilCalledWith = function (mock, expectedArgs, maxWaitMs) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (deepEqual(mock.mock.lastCall, expectedArgs))
                        return [2 /*return*/];
                    startTime = Date.now();
                    _a.label = 1;
                case 1:
...
export { createAsyncMock, resetAllPromises, spyOnAsync, untilCalledWith };
